      ...
      <div className="mx-24 mt-20">
        ...
        <div className="">
          ...
          <div className="flex gap-5">
            <div className=" w-[810px] h-[560px] bg-gray-400 my-5 p-5 rounded-3xl">
              <div className="w-[500px] h-[520px] bg-gray-300 mx-28 py-3 px-3 rounded-3xl ">
                ...
                <div className="flex rounded-2xl border border-gray-400 w-96 h-10 mb-5">
                  ...
                  <input type="number" onChange={handlePrincipalchange} className="w-full px-3" />
                </div>
                <h1 className=" pl-5">Interest rate:</h1>
                <input
                  type="number" onChange={handleInterestchange}
                  className=" rounded-2xl border border-gray-400 w-40 h-10 p-5"
                />
                ...
                <div className="my-5">
                  ...
                  <input
                    type="date"
                    className=" rounded-2xl border border-gray-400 w-46 h-10 p-5"
                  />
                </div>
                <div>
                  <button
                    type="submit" onClick={Calculateloan}
            ...
            <div className="w-full rounded-3xl  text-center bg-gray-400 text-xl py-4 px-3">
              <div className="grid  gap-8">
                ...
                <div>
                  <button className="px-5 py-3 bg-yellow-400 rounded-3xl">
          ...
          <div className="inline-block gap-5  my-10 mx-10">
            <div>
              <h1 className="text-2xl font-bold text-yellow-400 py-5">
                How does the car loan payoff calculator work?
              </h1>
              <h3>
                Our calculator helps you work out the costs associated with
                purchasing a car on credit. Once you have entered the amount,
                the interest rate and the period of the loan, the calculator
                will return the total repayment amount, the total interest and
                the monthly payment figure, as well as full amortization.
              </h3>
            </div>
            <div>
              <h1 className="text-2xl font-bold  text-black  py-5">
                How much interest will I pay on my car loan?
              </h1>
              <h3>
                The costs associated with purchasing a car on credit. Once you
                have entered the amount, the interest rate and the period of the
                loan, the calculator will return the total repayment amount, the
                total interest and the monthly payment figure, as well as full
                amortization.
              </h3>
            </div>
            <div>
              ...
              <h3>
                When it comes to financing a new car, there are a number of
                options available to you: outright purchase, personal loan,
                leasing, hire purchase or dealer financing. advisable to read up
                on the pros and cons of each of these before deciding upon the
                best one for you. Should you be considering taking out a
                different type of loan, give our standard loan calculator a try.
                You can even include extra payments in your calculation.
              </h3>
            </div>
            <div>
              <h1 className="text-2xl font-bold  text-black  py-5">
              ...
              <h3>
                A balloon payment is a large, lump-sum payment made at the end
                of a long-term loan. It is commonly used in car finance loans as
                a way of reducing monthly repayment figures. Be aware that once
                you reach the end of your loan period, the balloon amount
                becomes payable
              </h3>
            </div>
          </div>
